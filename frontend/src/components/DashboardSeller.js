...
const user=useSelector(state=>state.authReducer.user)
  ...
  return (
    <>
    {
        user&&user.role===1 ?     <div className='dash'>
        <div className="cont">
          ...
          <div className="main-container">
            ...
            <div className="videos">
              <div className="video anim" style={{"--delay":".4s"}}>
                ...
                <div className="video-view">54K views<span className="seperate video-seperate" />1 week ago</div>
              </div>
                  ...
                  <div className="chat-vid anim" style={{"--delay":".4s"}}>
                    <div className="chat-vid__wrapper">
                      ...
                      <div className="chat-vid__content">
                        ...
                        <div className="chat-vid__info">125.908 views <span className="seperate" />2 days ago</div>
                      </div>
                    </div>
                  </div>
