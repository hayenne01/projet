...
import {  updateproducts } from '../JS/actions/prodActions';
...
const [imageUrl, setimageUrl] = useState(null)
  ...
  const handleProduct = (e) => {
    ...
    dispatch(updateproducts(id,{name,price,description,imageUrl,shopUrl}, navigate))
                  ...
                  <div className="new-post-form product">
                    <form className="new-product-form">
                      ...
                      <div className="form-field field-2 medium">
                        ...
                        <input id="price" type="text" name="price" onChange={(e)=>setprice(e.target.value)} value={price} />
                      </div>
                      <div className="form-field field-3 medium">
                        <label htmlFor="shopURL">Shop URL</label>
                        <input id="shopURL" type="text" name="shopURL" onChange={(e)=>setshopUrl(e.target.value)} value={shopUrl} />
                      </div>
                      <div className="form-field field-4 medium">
                        <label htmlFor="description">Product Description</label>
                        <textarea id="description" type="text" rows={2} name="description" defaultValue={""} onChange={(e)=>setdescription(e.target.value)} value={description} />
                      </div>
<input type="file" id="myfile" name="myfile" onChange={(e)=> setimageUrl(e.target.files[0]) } />
                      <div className="new-post-actions">
                        ...
                        <div className="button-container">
                          <button onClick={handleProduct} className="publish" type="submit">Save</button>
                        </div>
                      </div>
                    </form>
                  </div>
